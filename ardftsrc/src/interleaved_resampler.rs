    ...
    T: Float + FftNum,
{
    ...
    pub fn finalize<'a>(&mut self, output: &mut [T]) -> Result<usize, Error> {
        ...
        // For each channel, process the chunk in the core, writing the output to the output_staging.
    ...
    // Utility function to convert a planar staging area to an interleaved output.
