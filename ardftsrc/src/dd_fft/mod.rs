//! Double-double-precision real FFT engine, compiled by the `dd_fft` feature and selected with
//! [`Config::dd_fft`](crate::Config::dd_fft) or
//! [`Config::with_dd_fft(true)`](crate::Config::with_dd_fft).
//!
