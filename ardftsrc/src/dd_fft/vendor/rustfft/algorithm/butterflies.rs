...
use crate::dd_fft::vendor::rustfft::array_utils::{DoubleBuf, LoadStore};
use crate::dd_fft::vendor::rustfft::twiddles;
use crate::dd_fft::vendor::rustfft::{Direction, Fft, Length};
...
impl<T: FftNum> Butterfly8<T> {
    ...
    pub fn new(direction: FftDirection) -> Self {
        Self {
            ...
            // avoids routing this constant through T::from_f64 (see dd_fft module docs).
