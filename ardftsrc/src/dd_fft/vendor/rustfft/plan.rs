...
use crate::dd_fft::vendor::rustfft::common::RadixFactor;
use crate::dd_fft::vendor::rustfft::{common::FftNum, fft_cache::FftCache, FftDirection};

use crate::dd_fft::vendor::rustfft::algorithm::butterflies::*;
use crate::dd_fft::vendor::rustfft::algorithm::*;
use crate::dd_fft::vendor::rustfft::Fft;

use crate::dd_fft::vendor::rustfft::math_utils::PrimeFactors;

// Vendored+trimmed from rustfft 6.4.1's `plan.rs`: only the SIMD-free `FftPlannerScalar` path is
// kept (see `dd_fft` module docs for why) -- the AVX/SSE/NEON/WASM planner variants and the
...
///
/// Use `FftPlannerScalar` instead of [`FftPlanner`](crate::dd_fft::vendor::rustfft::FftPlanner) or [`FftPlannerAvx`](crate::dd_fft::vendor::rustfft::FftPlannerAvx) when you want to explicitly opt out of using any SIMD-accelerated algorithms.
///
/// ~~~
